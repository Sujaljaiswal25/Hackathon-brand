...
const FooterSection = () => {
  ...
  return (
    <section className="footer-section mt-[30%] ">
      <img
      ...
      <div className="2xl:h-[110dvh] relative md:pt-[20vh] pt-[10vh]">
        ...
        <div className="my-40 h-[10vh] md:px-10 px-5 flex gap-10 md:flex-row flex-col justify-between text-milk font-paragraph md:text-lg font-medium">
